...
import { index, update } from '@/routes/admin/municipal-wastes';
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                type="number"
                                                min="1"
                                                defaultValue={municipalWaste.population_served ?? ''}
                                            />
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                min="1"
                                                max="31"
                                                defaultValue={municipalWaste.reporting_period_days ?? 1}
                                            />
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <select
                                                ...
                                                defaultValue={municipalWaste.collection_status ?? 'collected'}
                                                className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-ring"
                                            >
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <select
                                                ...
                                                defaultValue={municipalWaste.segregation_quality ?? 'mixed'}
                                                className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-ring"
                                            >
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input id="organic_weight_kg" name="organic_weight_kg" type="number" min="0" step="0.01" defaultValue={municipalWaste.organic_weight_kg ?? ''} />
                                            <InputError message={errors.organic_weight_kg} />
                                        </div>

                                        <div className="space-y-2">
                                            <Label htmlFor="recyclable_weight_kg">Recyclable Waste kg</Label>
                                            <Input id="recyclable_weight_kg" name="recyclable_weight_kg" type="number" min="0" step="0.01" defaultValue={municipalWaste.recyclable_weight_kg ?? ''} />
                                            <InputError message={errors.recyclable_weight_kg} />
                                        </div>

                                        <div className="space-y-2">
                                            <Label htmlFor="hazardous_weight_kg">Hazardous Waste kg</Label>
                                            <Input id="hazardous_weight_kg" name="hazardous_weight_kg" type="number" min="0" step="0.01" defaultValue={municipalWaste.hazardous_weight_kg ?? ''} />
                                            <InputError message={errors.hazardous_weight_kg} />
                                        </div>

                                        <div className="space-y-2">
                                            <Label htmlFor="medical_weight_kg">Medical Waste kg</Label>
                                            <Input id="medical_weight_kg" name="medical_weight_kg" type="number" min="0" step="0.01" defaultValue={municipalWaste.medical_weight_kg ?? ''} />
                                            <InputError message={errors.medical_weight_kg} />
                                        </div>

                                        <div className="space-y-2">
                                            <Label htmlFor="overflow_spots">Overflow Spots</Label>
                                            <Input id="overflow_spots" name="overflow_spots" type="number" min="0" max="255" defaultValue={municipalWaste.overflow_spots ?? 0} />
                                            <InputError message={errors.overflow_spots} />
                                        </div>

                                        <div className="space-y-2">
                                            <Label htmlFor="odor_level">Odor Level</Label>
                                            <Input id="odor_level" name="odor_level" type="number" min="0" max="5" defaultValue={municipalWaste.odor_level ?? 0} />
                                            <InputError message={errors.odor_level} />
                                        </div>

                                        <div className="space-y-2">
                                            <Label htmlFor="missed_collection_days">Missed Collection Days</Label>
                                            <Input id="missed_collection_days" name="missed_collection_days" type="number" min="0" defaultValue={municipalWaste.missed_collection_days ?? 0} />
                                            <InputError message={errors.missed_collection_days} />
                                        </div>

                                        <label className="flex items-center gap-2 text-sm font-medium">
                                            <input type="hidden" name="standing_water" value="0" />
                                            <input id="standing_water" name="standing_water" type="checkbox" value="1" defaultChecked={municipalWaste.standing_water ?? false} />
                                        ...
                                        <div className="space-y-2 md:col-span-2">
                                            ...
                                            <textarea
                                                id="notes"
                                                name="notes"
                                                defaultValue={municipalWaste.notes ?? ''}
